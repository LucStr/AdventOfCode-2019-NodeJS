class IntCodeComputer{
    constructor(data, continueOnOutput, immediateOutput){
        this.memory = [...data];
        this.inputData = [];
        this.index = 0;
        this.relativeBase = 0;
    ...
    run(){
        ...
        var operations = {
            ...
            4: (a) => { !this.immediateOutput && this.outputHandler(this.memory[a]); this.halted = !this.continueOnOutput; return this.memory[a] },
        ...
        while(!this.halted){
            ...
            var out = operations[opCode].apply(this, parameterConfig.map((config, index) => {
            ...
            if(this.immediateOutput && opCode === 4){
                return out;
            }
        }
    }    
